namespace Zotapay.Models
{
    ...
    internal class UserAgent
    {
        ...
        public static string GetUserAgentHeader()
        {
            ...
            try
            {
                currentVersion = Assembly.LoadFrom("Zotapay.dll").GetName().Version.ToString();
            }
            catch
            {
                // set the version manually in case of failure
                currentVersion = "1.1.6e";
            }
        ...
        private static bool Is64Bit() { return Environment.Is64BitOperatingSystem; }
        ...
        /// </summary>
        private static string DotNetVersion { get { return Environment.Version.ToString(); } }
    }
}
